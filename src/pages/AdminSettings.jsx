            ...
            <div className="settings-grid">
              ...
              <div className="apf-card">
                ...
                <div className="apf-field">
                  ...
                  {form.promo_image && !form.promo_image_file && (
                    <img src={`${storageUrl(form.promo_image)}`} alt="Promo" style={{ width: '120px', height: '80px', objectFit: 'contain', marginTop: '8px', borderRadius: '6px', border: '1px solid #e0e0e0' }} />
                  )}
              ...
              <div className="apf-card">
                ...
                {form.nouveautes_image && !form.nouveautes_image_file && (
                  <img src={`${storageUrl(form.nouveautes_image)}`} alt="Nouveautés" style={{ width: '100%', maxHeight: '200px', objectFit: 'cover', borderRadius: '8px', border: '1px solid #e0e0e0', marginTop: '12px' }} />
                )}
